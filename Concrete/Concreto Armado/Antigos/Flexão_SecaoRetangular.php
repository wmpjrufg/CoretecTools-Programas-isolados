...
echo "Flexão Simples - Seção Retangular\n";
echo "-----------------------------------------------\n\n";
...
$cob = 2.5; //cm´
$phiestribo = 6; //mm
$d = 29; //cm (essa é a variável do incremento 0.8h<=d<=0.9h)
$md = 63; //kN.m
//--------------------------------------------------------------//
...
if ($phiestrib > 12.5) {
    $error = 1;
    echo "estribo maior que o limite aceitável\n";
    return;
}
...
if ($armadura == "SIMPLES") {
  ...
  $mlim = $bw * $alfac * ($fcd/10) * $lambda * $xlim * $zlim; //kN.cm
