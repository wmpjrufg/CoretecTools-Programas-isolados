...
//
// O programa abaixo desenha uma seção transversal retangular com a quantidade de armadura Phi longitudinal necessária
...
//
  ...
  let phias1           = 8.00/ 10;         //<----aqui usuário muda
  let ahas1            = 2.5;              //<----aqui usuário muda
  let avas1            = 2.5;              //<----aqui usuário muda
  let camadaBolinhaas1 = [8,6,4,5,1];   //<----aqui usuário muda
...
//  
  ...
  // Desenho das bitolas em cada camada
