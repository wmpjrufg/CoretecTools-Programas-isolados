...
// Versão:  LAJEFLEXAOPURACONCRETOARMADO02_v00_principal
...
function LAJEFLEXAOPURACONCRETOARMADO02_v00_armadura($tipomomento,$d,$bw,$fcd,$fyd,$md,$lambda,$alfac,$epsiloncu,$epsilonsyield,$fctksup,$ac,$w,$duct)
{
...
if (is_nan($kx)){
$erro = 9;
LAJEFLEXAOPURACONCRETOARMADO02_v00_erros($erro);
return;
}
...
if ($astot > $asmax){
  $aviso = 2;
  LAJEFLEXAOPURACONCRETOARMADO02_v00_avisos($aviso); 
}
